...
namespace Webapp.Application.Catalog
{
    public class ManageProductService : IManageProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if(product == null || productTranlations == null) throw new WebappException($"Can't not find product with Id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new WebappException($"Can't not find product with Id: {productId}");
